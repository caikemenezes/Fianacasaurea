...
-- Planilha de orçamento mensal por categoria, dentro de Contas do Mês —
-- quanto a família reserva por mês pra cada coisa (água, luz, alimentação),
-- agrupado em categorias fixas definidas em código (GRUPOS_ORCAMENTO, ver
-- public/contas.php), não cadastráveis pelo usuário. Diferente de Contas do
-- Mês (contas reais com vencimento), é só um valor de planejamento por
-- categoria.
